  ...
  return (
    <div name="about" className='w-full bg-gradient-to-b from-gray-800 to-black text-white'>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
            ...
            Bonjour !<br/><br/>
            Je m'appelle Romain, j'ai 23 ans et je suis passionné d'informatique depuis le lycée. Mon intérêt pour la programmation m'a amené à poursuivre des études dans ce domaine. <br/>Je suis actuellement en BTS SIO options SLAM à l'école IPSSI à Marne-la-Vallée. <br/> <br/>Ensuite je compte effectuer une  Licence 3 MIASHS
